    ...
    return (
        <QuestionsBlock id='questions'>
            <Container>
                ...
                <QuestionsInner>
                    {questions.map(question => <Question key={question.id} id={question.id} title={question.title} description={question.description} isActive={question.isActive} onClick={changeQuestions}  />)}
                </QuestionsInner>
            </Container>
        </QuestionsBlock>
    )
